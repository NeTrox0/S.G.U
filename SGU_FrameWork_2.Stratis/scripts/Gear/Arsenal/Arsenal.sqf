...
switch (_cammo) do {
	case (1): { //1:M90K
		switch (_role) do {
			...
			case ("KSP58"): {
				...
				//GRG ASS
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>GRG Assistent</t>", {[player,1,"GRGA"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
			};
			case ("GRG"): {
			...
			default {
				...
				//FARB
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>Fältarbetare</t>", {[player,1,"FARB"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
				//GRG ASS
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>GRG Assistent</t>", {[player,1,"GRGA"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
			};
		};
	...
	case (2): { //2:MC
		switch (_role) do {
			...
			case ("KSP58"): {
				...
				//GRG ASS
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>GRG Assistent</t>", {[player,2,"GRGA"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
			};
			case ("GRG"): {
			...
			default {
				...
				//FARB
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>Fältarbetare</t>", {[player,2,"FARB"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
				//GRG ASS
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>GRG Assistent</t>", {[player,2,"GRGA"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
			};
		};
	...
	case (3): { //3:MCT
		switch (_role) do {
			...
			case ("KSP58"): {
				...
				//GRG ASS
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>GRG Assistent</t>", {[player,3,"GRGA"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
			};
			case ("GRG"): {
			...
			default {
				...
				//FARB
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>Fältarbetare</t>", {[player,3,"FARB"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
				//GRG ASS
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>GRG Assistent</t>", {[player,3,"GRGA"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
			};
		};
	...
	//Lead Roles
			...
			case ("KSP58"): {
				...
				//GRG ASS
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>GRG Assistent</t>", {[player,0,"GRGA"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
			};
			case ("GRG"): {
			...
			default {
				...
				//FARB
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>Fältarbetare</t>", {[player,0,"FARB"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
				//GRG ASS
				_object addAction ["<t size='1' shadow='1' color='#00ff00'>GRG Assistent</t>", {[player,0,"GRGA"] execVM "scripts\gear\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
			};
		};
